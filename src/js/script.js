...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var start = new webService("https://simonlobo.ddns.net/workout/workoutlog.php/logs");
...
function save_row(x) {
    ...
    var upd = new webService("https://simonlobo.ddns.net/workout/workoutlog.php/logs");
    // Update the log
...
function del_row(x) {
    ...
    if (c == true) {
        var del = new webService("https://simonlobo.ddns.net/workout/workoutlog.php/logs");
        del["delete"](x);
    }
}
/**
